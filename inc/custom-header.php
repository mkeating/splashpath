...
function nhs3_s_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'nhs3_s_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'nhs3_s_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'nhs3_s_custom_header_setup' );

if ( ! function_exists( 'nhs3_s_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see nhs3_s_custom_header_setup().
 */
